...
namespace CloudMineServer.Data.Migrations
{
    ...
    [Migration("20161129082347_chunksForModel")]
    partial class chunksForModel
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("CloudMineServer.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CloudMineServer.Models.ApplicationUser")
                        .WithMany("Claims")
